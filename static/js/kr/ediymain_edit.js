...
$(function () {
   ...
   /* imgtext_editor.clickToolbar('image', function() {
      ...
      //初始化kindeditor
    profile_editor = KindEditor.create('#workcomment', {
        basePath: '/static/kindeditor/',
        bodyClass : 'article-content',
        resizeType : 1,
        allowPreviewEmoticons : false,
   ...
   profile_editor.clickToolbar('image', function() {
        chooseMediaResCallBack = profile_choose_img_ok;
        pauseAudioMusic();
        var imgType = "custom";
        $("#pic").html("");
        $("#music").html("");
...
function vlookatSlide(value) {
    ...
    var viewobj = $("#panoSettingModal .eyes").data(scene_name);
    viewobj.vlookat = value;
    $("#panoSettingModal .eyes").data(scene_name,viewobj);
}
...
$(document).ready(function () {
    ...
    $(".pano-setting-container button").click(function () {
        ...
        objM.siblings().animate({right: '-370px'}, 1);
...
function profile_choose_img_ok(mediaData){
    profile_editor.appendHtml("<img src='"+mediaData.src+"' width='200px' />");
    // imgtext_editor.exec('insertimage', mediaData.src, 'title', 200, 100, 1, 'right');
}
...
function updateEffectSetting(a, b, c) {  
    var e, d = $("#panoSettingModal .specialEffect").data(a);
    d.ath = b,
    d.atv = c,
    e = document.getElementById("panoSettingObject"),
    e.call("addLensflares(" + b + "," + c + ")")
}
//截断缩略图后边的问号，获得原图
