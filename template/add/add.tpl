...
<link rel="stylesheet" href="/template/{$_lang.moban}/css/fileinput.min.css">
<link rel="stylesheet" href="/template/{$_lang.moban}/css/chosen.min.css">
<div class="container">
...
<script>
	var up_url = "{$up_url}";
    var global_storage ='{$_lang.global_storage}';
	var qn_video_token;
	var videoParams={} ;
...
<link rel="stylesheet" href="/template/{$_lang.moban}/css/qiniu_main.css">
<script>
{literal}
...
{/literal}
{else if $img_store_type eq 'local'}
