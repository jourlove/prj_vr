...
(function (w, d, undefined) {
    ...
    if (_U.isDev) {
        ...
        _U.loadCss('/template/default/css/zui-theme.css');
        _U.loadCss('/template/default/css/fileinput.min.css');
        _U.loadCss('/template/default/css/bootstrap-switch.css');
        _U.loadCss('/template/default/css/chosen.min.css');
        _U.loadCss('/template/default/css/zui.datatable.min.css');
        //_U.loadCss'../plugin/loading/msgbox.css');
       // _U.loadCss('/static/css/kr/common.css');
        _U.loadCss('/template/default/css/response.css');
