...
<script language="JavaScript" type="text/javascript" src="/template/{$_lang.moban}/js/uhweb.js"></script>
...
<link rel="stylesheet" href="/template/{$_lang.moban}/css/font-awesome.css">
...
{include file="{$_lang.moban}/library/nav2.lbi"}
