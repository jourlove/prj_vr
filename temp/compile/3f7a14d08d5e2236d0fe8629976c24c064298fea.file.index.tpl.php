<?php /* Smarty version Smarty-3.1.7, created on 2018-05-21 23:12:26
         compiled from "D:/Develop/xampp/htdocs/prj_vr/vradmin/template\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6404230855b02e1dadf9a53-24477335%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3f7a14d08d5e2236d0fe8629976c24c064298fea' => 
    array (
      0 => 'D:/Develop/xampp/htdocs/prj_vr/vradmin/template\\index.tpl',
      1 => 1526093148,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6404230855b02e1dadf9a53-24477335',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b02e1db093fc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b02e1db093fc')) {function content_5b02e1db093fc($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
/?m=theme"><i class="theme"></i><em>设置模板</em></a></li>
  ...
  <ul>
  <li <?php if ($_smarty_tpl->tpl_vars['module']->value=='slide'){?>class="cur"<?php }?>><a href="/<?php echo $_smarty_tpl->tpl_vars['_lang']->value['admin_path'];?>
/?m=slide"><i class="show"></i><em>首页广告</em></a></li> 
 </ul>
   <ul>
  <li <?php if ($_smarty_tpl->tpl_vars['module']->value=='ad'){?>class="cur"<?php }?>><a href="/<?php echo $_smarty_tpl->tpl_vars['_lang']->value['admin_path'];?>
/?m=ad"><i class="show"></i><em>广告管理</em></a></li> 
 </ul>
 <ul>
...
<div id="dcFooter">
 <div id="footer">
  <div class="line"></div>
  <ul>
   Copyright&copy;2018　<?php echo $_smarty_tpl->tpl_vars['_lang']->value['title'];?>
