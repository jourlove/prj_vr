<?php /* Smarty version Smarty-3.1.7, created on 2018-05-21 23:55:41
         compiled from "D:/Develop/xampp/htdocs/prj_vr/template\default\member\mediares.lbi" */ ?>
<?php /*%%SmartyHeaderCode:17847505715b02ebfdd24749-85478083%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '62ae2b6caa07a98bf48e477cc6798724b40a9a5c' => 
    array (
      0 => 'D:/Develop/xampp/htdocs/prj_vr/template\\default\\member\\mediares.lbi',
      1 => 1526807918,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17847505715b02ebfdd24749-85478083',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b02ebfe033fc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b02ebfe033fc')) {function content_5b02ebfe033fc($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['_lang']->value['moban'])."/library/member_paths.lbi", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<div class="content">
	<div class="nav_wrap">
      <ul class="nav nav-secondary">
        <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='panos'){?>class="active"<?php }?>><a href="/member/mediares?act=panos">全景图片</a></li>
        <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='material'){?>class="active"<?php }?>><a href="/member/mediares?act=material">素材图片</a></li>
        <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='msc'){?>class="active"<?php }?>><a href="/member/mediares?act=msc">音乐</a></li>
        <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='video'){?>class="active"<?php }?>><a href="/member/mediares?act=video">视频</a></li>
        <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='video_tie'){?>class="active"<?php }?>><a href="/member/mediares?act=video_tie">贴片视频</a></li>
		...
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['act']->value=='video'){?>
		<button class="btn btn-primary up_btn" data-toggle="modal" data-target="#video_up_modal">上传视频</button>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['act']->value=='video_tie'){?>
      	<button class="btn btn-primary up_btn" data-toggle="modal" data-target="#video_up_modal">上传贴片视频</button>
		<?php }?>
      </ul>
    </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
             <input id="panoUpload" name="file" type="file" multiple="" accept="image/jpeg,image/tiff" class="">
             <input type="button" id="confirmUpload" class="btn btn-success btn-block" style="margin-top: 10px;" value="确认上传">
        </div>
      </div>
    </div>
  </div>
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-muted"><img src="/static/images/loading.gif" alt="">图片上传成功，请等待服务器处理</p>
      </div>
...
<script language="JavaScript" type="text/javascript" src="/template/<?php echo $_smarty_tpl->tpl_vars['_lang']->value['moban'];?>
/js/fileinput-v4.34.js"></script>
<script language="JavaScript" type="text/javascript" src="/template/<?php echo $_smarty_tpl->tpl_vars['_lang']->value['moban'];?>
/js/fileinput_locale_zh.js"></script>
<script>
...
";
 ...
 $("#panoUpload").fileinput({
      ...
      var files =  $('#panoUpload').fileinput('getFileStack');
      //构造每次请求的key
      var extraData = $("#panoUpload").fileinput('uploadExtraData');
    ...
    $("#confirmUpload").click(function(){
      ...
      var files =  $('#panoUpload').fileinput('getFileStack');
      if(files.length<=0){
        $('#panoUpload').fileinput('_showError','请先上传文件');
        return false;
      }
      $("#panoUpload").fileinput("upload");
    })
...
function commit(){
  // alert_notice('文件上传成功，请等待服务器处理','success','top',0);
  $("#myModal").modal({
    keyboard : false,
    show     : true,
    position : 'center',
...
<?php }elseif($_smarty_tpl->tpl_vars['_lang']->value['global_storage']=='local'){?>
...
<?php }elseif($_smarty_tpl->tpl_vars['act']->value=="video_tie"){?>
  <div class="list_wrap">
      <div class="cards">
      </div>
      <div id="pager_wrap" style="text-align:center"></div>
          ...
          <div class="row">
            ...
            <div class="row">
                ...
                <!-- <div class="col-md-1 col-md-offset-1">
                  <button class="btn" id="coverupload" name="video">选择封面</button>
                </div> -->
                <div class="col-md-2 col-md-offset-1">
                    <button id="publish_video" class="btn btn-primary btn-block">确定上传</button>
                </div>
...
";
  ...
  var coverParams=new Array() ;
    ...
    $('.close').click(function(){
        $("#video_play_modal .modal-body video").attr('src','');
    })
...
<?php }elseif($_smarty_tpl->tpl_vars['_lang']->value['global_storage']=='local'){?>
  ...
  $(function(){
    var upload=new Upload_Video();
    upload.Init('videoupload',up_url+"?act=videotie",success_Upload,'videotie');
    video_up=upload.video_up;
  });
  function success_Upload(obj){
	  var videoParams=obj.videoParams.videos;
            ...
            for (var i = 0; i <list.length; i++) {
                ...
                if(type==1){
                 ...
                 h += ' <div class="col-md-4 col-sm-6 col-lg-3">'+
                  ...
                  '<div class="audio_wrap" data-location="'+o.absolutelocation+'" style="background-image: url('+o.cover+');" ><img src="/static/images/play.png" alt="'+o.media_name+'"><span></span></div>'+
                    ' <div class="card-content">'+
                   '<div class="row">'+
                   '<div class="col-md-8"><span class="text-muted card_text" id="panos_name_'+o.pk_media_res+'">'+o.media_name+'</span></div>'+
                  '        <div class="col-md-4">'+
